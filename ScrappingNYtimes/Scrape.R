...
### set parameters ###
api <- "a4b5bb54076c40ebb12bdfe65c471411" #<<<<<<<<<<<<<===== API key goes here
q <- "India+Modi" # Query string, use + instead of space
records <- 5 #how many results do we want? (Note limitations)
